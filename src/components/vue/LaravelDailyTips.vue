<template>
  <div class="card">
    <div class="card-body">
      <div
        class="card-title -mt-20 flex justify-between pt-20"
        id="laravel-tips"
      >
        Laravel Daily Tips
        <div
        ...
        >
          <button
            aria-label="Refresh"
            class="btn btn-circle btn-secondary btn-sm uppercase"
            :disabled="refreshing"
            @click="fetchTips"
          >
            <svg
      ...
      <div class="stack mx-auto mt-6 w-full">
        <div
          class="card h-96 bg-secondary shadow-xl"
        ...
        >
          ...
          >
            <figure
              class="h-96 w-full object-cover transition-opacity"
          ...
          <div class="card-body" v-show="!loading">
            ...
            >
              <p
                class="card-title transform transition"
            ...
            <div class="card-actions justify-end">
              <button class="btn btn-primary uppercase" @click="openModal">
                Visualizza
              </button>
            </div>
          </div>
        ...
        <div
          class="card h-24 cursor-pointer bg-secondary"
          v-on:click="nextTip"
        ></div>
        <div
          class="card h-24 cursor-pointer bg-secondary"
